$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Boda Ana y Jero",

            // Event start date
            start: new Date('Jul 25, 2020 18:00'),
            ...
            end: new Date('Jul 26, 2020 00:00'),
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'b0e53b10c1f55ede516b240036b88f40'
            ...
            $.post('https://script.google.com/macros/s/AKfycbyevD1ZUTbIrgKQ6R9BMLBhZ4kHBGtYI094AfUlt7OHCIKDCdg5/exec', data)
                .done(function (data) {
                    console.log(data);
